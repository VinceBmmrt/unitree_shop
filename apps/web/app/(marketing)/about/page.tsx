...
const milestones = [
  ...
  {
    year: '2019',
    event: 'Lancement du A1, premier robot quadrupède grand public à moins de 10 000 $.',
  },
      ...
      <section className="pt-32 pb-24 px-4 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto max-w-3xl">
          ...
          <p className="mt-6 text-slate-500 dark:text-zinc-400 text-xl max-w-2xl leading-relaxed">
            Unitree Robotics développe des robots humanoïdes et quadrupèdes de classe mondiale,
            rendus accessibles à tous — chercheurs, ingénieurs, entreprises.
          </p>
          <div className="mt-8 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-2xl">
            {[
              ...
              <div
                key={label}
                className="p-4 rounded-xl border border-slate-200 dark:border-border bg-slate-50 dark:bg-white/[0.02] text-center"
              >
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {values.map(({ icon: Icon, title, body }) => (
              <div
                key={title}
                className="p-6 rounded-2xl border border-slate-200 dark:border-border bg-slate-50 dark:bg-white/[0.02] hover:border-blue-200 dark:border-blue-500/20 transition-all"
              >
      ...
      <section className="py-24 px-4 bg-slate-50 dark:bg-[#06060f] relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          ...
          <p className="mt-4 text-slate-500 dark:text-zinc-400 text-lg">
            Que vous soyez chercheur, industriel ou entrepreneur, il y a une place pour vous dans
            l&apos;écosystème Unitree.
          </p>
