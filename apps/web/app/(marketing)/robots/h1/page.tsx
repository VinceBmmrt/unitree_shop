...
export const metadata: Metadata = {
  ...
  description: 'H1 : robot humanoïde full-size, 43 DoF, 3.3 m/s, 30 kg de charge. Conçu pour les environnements industriels complexes.',
};
    ...
    <main className="bg-white dark:bg-[#04040a] text-slate-900 dark:text-white">
        ...
        <div className="relative max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-16 items-center pt-28 pb-16">
          ...
          <div>
            ...
            <h1 className="font-display text-5xl md:text-7xl font-bold tracking-tight leading-[1.02]">
              Unitree<br />
              <span className="bg-gradient-to-r from-white to-zinc-400 bg-clip-text text-transparent">H1</span>
            </h1>
            <p className="mt-6 text-slate-500 dark:text-zinc-400 text-xl max-w-lg leading-relaxed">
              Le robot humanoïde full-size d&apos;Unitree. 43 degrés de liberté,
              30 kg de charge utile, conçu pour les déploiements industriels et la recherche de pointe.
            </p>
      ...
      <section className="py-24 px-4 bg-slate-50 dark:bg-[#06060f]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-blue-400 font-medium text-sm uppercase tracking-widest mb-3">Capacités</p>
            <h2 className="font-display text-4xl font-bold tracking-tight text-slate-900 dark:text-white">Conçu pour les cas d&apos;usage exigeants.</h2>
          </div>
      ...
      <section className="py-24 px-4 bg-slate-50 dark:bg-[#06060f] relative overflow-hidden">
        ...
        <div className="relative max-w-2xl mx-auto text-center">
          <h2 className="font-display text-4xl font-bold tracking-tight text-slate-900 dark:text-white">Prêt à déployer le H1 ?</h2>
          <p className="mt-4 text-slate-500 dark:text-zinc-400 text-lg">Notre équipe vous accompagne de la phase pilote au déploiement à grande échelle.</p>
