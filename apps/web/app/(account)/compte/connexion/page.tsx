    ...
    <main className="min-h-screen bg-white dark:bg-[#04040a] flex items-center justify-center px-4">
      ...
      <div className="relative w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-1.5">
                ...
                <Link href="/compte/mot-de-passe-oublie" className="text-xs text-blue-600 dark:text-blue-400 hover:underline">
                  Mot de passe oublié ?
                </Link>
              </div>
        ...
        <p className="text-center mt-6 text-sm text-slate-500 dark:text-zinc-400">
          ...
          <Link href="/compte/inscription" className="text-blue-600 dark:text-blue-400 font-medium hover:underline">
            Créer un compte
          </Link>
        </p>
      </div>
